 ...
 * @author shanki
 */
public class ProgramDirect04Test {
    ...
    public void testPAS_BEW() throws SolverException {
        ...
        AnswerSets result   = new NonGroundSolver(new PasBEWMetaSolver(new NonGroundSolver(new DisjunctiveTransSolver(new BuiltInSmodelsSolver())))).evaluate(program, 0);
