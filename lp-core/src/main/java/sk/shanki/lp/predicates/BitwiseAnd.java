 ...
 * @author shanki
 */
public class BitwiseAnd implements GroundingPredicate {
    ...
    public BitwiseAnd(Term x, Term y, Term right) {
        this.x = x;
        this.y = y;
        this.right = right;
    ...
    public boolean equals(Object obj) {
        ...
        final BitwiseAnd other = (BitwiseAnd) obj;
